      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/products')
          ...
          .end(function (productSaveErr, productSaveRes) {
            ...
            // product.priceincludevat = 100;
            // product.priceexcludevat = 93;
            ...
            agent.put('/api/products/' + productSaveRes.body._id)
              ...
              .end(function (productUpdateErr, productUpdateRes) {
                ...
                (productUpdateRes.body.saleprice).should.match(200);
                (productUpdateRes.body.isincludevat).should.match(false);
                (productUpdateRes.body.priceincludevat).should.match(200 * 1.07);
                (productUpdateRes.body.priceexcludevat).should.match(200);
          ...
          .end(function (productSaveErr, productSaveRes) {
            ...
            agent.put('/api/products/' + productSaveRes.body._id)
              ...
              .end(function (productUpdateErr, productUpdateRes) {
                ...
                (productUpdateRes.body.priceincludevat).should.match(200);
                (productUpdateRes.body.priceexcludevat).should.match(200 / 1.07);
